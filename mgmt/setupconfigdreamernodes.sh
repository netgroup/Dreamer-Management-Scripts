#!/bin/bash
# The script setup and configure a group of DREAMER nodes (non OSHI nodes)
...
dsh -M -g $1 -c "tar -xvzf /ofelia/users/${USERS[0]}/dreamernodes.tar.gz && bash /ofelia/users/${USERS[0]}/dreamernodes/setup.sh"
